...
#
# This dockerfile airgaps Lake 1.8.0 dependencies to the airgap/ directory.
#   Iceberg 1.8.0
#   Spark 3.5.4
#   Nessie 0.103.0
#   Awssdk 2.29.29
...
RUN wget https://github.com/projectnessie/nessie/releases/download/nessie-0.103.0/nessie-quarkus-0.103.0-runner.jar -O /airgap/archive/nessie-quarkus-0.103.0-runner.jar
RUN wget https://github.com/projectnessie/nessie/releases/download/nessie-0.103.0/nessie-cli-0.103.0.jar -O /airgap/archive/nessie-cli-0.103.0.jar
...
<ivy-module version="2.0">\
   ...
   <dependencies>\
       ...
       <dependency org="org.projectnessie.nessie-integrations" name="nessie-spark-extensions-3.5_2.12" rev="0.103.0" />\

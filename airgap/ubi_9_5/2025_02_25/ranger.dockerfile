...
RUN cd apache-ranger-2.5.0;export JAVA_HOME=/usr/lib/jvm/java-1.8.0-openjdk;export PATH=$JAVA_HOME/bin:$PATH; export MAVEN_OPTS="-Xmx2048m -XX:MaxPermSize=512m";mvn clean compile package install -DskipJSTests -DskipTests -Pranger-admin

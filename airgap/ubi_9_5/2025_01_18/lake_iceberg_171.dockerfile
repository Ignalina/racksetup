...
#
# This dockerfile airgaps Lake 1.7.1 dependencies to the airgap/ directory.
#   Iceberg 1.7.1
#   Spark 3.5.4
#   Nessie 0.102.4
#   Awssdk 2.29.29
...
RUN wget https://github.com/projectnessie/nessie/releases/download/nessie-0.102.4/nessie-quarkus-0.102.4-runner.jar -O /airgap/archive/nessie-quarkus-0.102.4-runner.jar
RUN wget https://github.com/projectnessie/nessie/releases/download/nessie-0.102.4/nessie-cli-0.102.4.jar -O /airgap/archive/nessie-cli-0.102.4.jar
...
RUN wget https://dl.min.io/server/minio/release/linux-amd64/archive/minio-20250118003137.0.0-1.x86_64.rpm -O /airgap/archive/minio-20250118003137.0.0-1.x86_64.rpm
...
<ivy-module version="2.0">\
   ...
   <dependencies>\
       ...
       <dependency org="org.projectnessie.nessie-integrations" name="nessie-spark-extensions-3.5_2.12" rev="0.102.4" />\

...
#
   ...
   echo 'spark.jars.packages=org.apache.hadoop:hadoop-aws:3.3.2,org.mariadb.jdbc:mariadb-java-client:3.1.3,org.projectnessie.nessie-integrations:nessie-deltalake:0.59.0,org.projectnessie.nessie-integrations:nessie-spark-3.2-extensions:0.59.0,software.amazon.awssdk:sts:2.20.18,software.amazon.awssdk:s3:2.20.18,software.amazon.awssdk:url-connection-client:2.20.18' >> conf/spark-defaults.conf

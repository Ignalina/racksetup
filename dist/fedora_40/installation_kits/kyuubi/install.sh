...
then
   ...
   tar -zxf apache-kyuubi-1.9.2-bin.tgz
...
cp kyuubi-env.sh /usr/lib/x14/kyuubi/apache-kyuubi-1.9.2-bin/conf/kyuubi-env.sh
...
wget https://dlcdn.apache.org/kyuubi/kyuubi-1.9.2/apache-kyuubi-1.9.2-source.tgz
tar -zxf apache-kyuubi-1.9.2-source.tgz
cd apache-kyuubi-1.9.2-source
build/mvn clean package -pl :kyuubi-spark-authz_2.12 -DskipTests -Dspark.version=3.5.2 -Dranger.version=2.4.0
...
cp ./extensions/spark/kyuubi-spark-authz/target/kyuubi-spark-authz_2.12-1.9.2.jar /usr/lib/x14/spark/spark-3.5.2-bin-hadoop3/jars/
cp ./extensions/spark/kyuubi-spark-authz/target/scala-2.12/jars/* /usr/lib/x14/spark/spark-3.5.2-bin-hadoop3/jars/

chown spark:x14 /usr/lib/x14/spark/spark-3.5.2-bin-hadoop3/jars/*

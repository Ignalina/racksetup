   ...
   echo 'software.amazon.awssdk:bundle:2.29.29,spark.jars.packages=org.apache.hadoop:hadoop-aws:3.4.1,org.mariadb.jdbc:mariadb-java-client:3.1.3,org.projectnessie.nessie-integrations:nessie-spark-extensions-3.5_2.12:0.99.0,org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.7.0,software.amazon.awssdk:sts:2.29.29,software.amazon.awssdk:s3:2.29.29,software.amazon.awssdk:url-connection-client:2.29.29' >> conf/spark-defaults.conf
   ...
   then
      ...
      wget https://github.com/projectnessie/nessie/releases/download/nessie-0.99.0/nessie-quarkus-0.99.0-runner
      chmod +x nessie-quarkus-0.99.0-runner
